...
> **Personal note:** I'm using this project to learn how LLM agents can be composed together for financial analysis. My main interest is in comparing how different investing philosophies (e.g. Munger vs. Cathie Wood) react to the same stock.
